<%@ Page Language="VB" Debug="true" AutoEventWireup="false" CodeFile="demo.aspx.vb" Inherits="demo" %>
...
<!-- START Demo Code -->
<form name="RTEDemo" action="demo.aspx" method="post" onsubmit="return submitForm();">
...
initRTE("../cbrte/images/", "../cbrte/", "", true, true);
//-->
</script>
